...
class Dog :
	...
	class_variable = "this can be accessed by any class object"
	
	def __init__(self,name,age) : # called when object is created
		"""initialize name and age"""  # doc-string

		self.name = name # class instance variable (unique for each class instanace)
		self.age = age 
...
lucky_ticket.winner()
lucky_ticket.find_count("00001") # how many times till i win


# difference between self.settings = Settings() and inheriting it 
	# 1st case : each class make its own instance of Settings and stores it in self.settings 
	# 2nd case : use when the class is an special version of "Settings" class 
